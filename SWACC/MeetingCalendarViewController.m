//
//  MeetingCalendarViewController.m
//  SWACC
//
...
@interface MeetingCalendarViewController ()

@end

@implementation MeetingCalendarViewController
...
- (void)createScrollMenu
{
    ...
    UIView *bottomBorder = [[UIView alloc] initWithFrame:CGRectMake(0, titleBtn.frame.size.height - 1.0f, titleBtn.frame.size.width, 1)];
    bottomBorder.backgroundColor = [UIColor colorWithHexString:@"03687f"];
    [titleBtn addSubview:bottomBorder];
