...
//        [self handleSingleTap:path];
        ...
        targetURL = [NSURL URLWithString:@"https://23.253.109.178/swacc/docs/Title_IX_Announcement_4_9_15.pdf"];
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"Sept  Insight 2015 KSC Title IX" ofType:@"pdf"];
        [self handleSingleTap:path];

        //targetURL = [NSURL URLWithString:@"https://23.253.109.178/swacc/docs/Title_IX_Announcement_4_9_15.pdf"];

    }else{
        //targetURL = [[NSBundle mainBundle] URLForResource:@"BRF_20160524_TitleIXandAB1266TransgenderStudents_KA" withExtension:@"pdf"];
    }
...
- (void)createScrollMenu
{
    ...
    UIView *bottomBorder = [[UIView alloc] initWithFrame:CGRectMake(0, eplBtn.frame.size.height - 1.0f, eplBtn.frame.size.width, 1)];
    bottomBorder.backgroundColor = [UIColor colorWithHexString:@"03687f"];
    [eplBtn addSubview:bottomBorder];
